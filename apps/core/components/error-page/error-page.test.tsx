...
describe("<ErrorPage />", async () => {
  ...
  it("renders error-like object properties", async () => {
    render(<ErrorPage error={{ name: "Server Error", message: "Internal server error" }} />)
  ...
  it("renders action and details", async () => {
    const error = new Error("The page you're looking for doesn't exist or has been moved.")
